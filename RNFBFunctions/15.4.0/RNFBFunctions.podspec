...
Pod::Spec.new do |s|
  ...
  s.source              = { :git => "https://github.com/BunnarithHeang/react-native-firebase.git", :tag => "v#{s.version}-Patch" }
  s.social_media_url    = 'http://twitter.com/invertaseio'
  s.ios.deployment_target = "10.0"
  s.source_files        = 'packages/functions/ios/**/*.{h,m}'
  ...
  s.pod_target_xcconfig = {
                            ...
                            "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)/React-Core/Default/\" \"$(PODS_ROOT)/FirebaseFunctions/\""
                          }
